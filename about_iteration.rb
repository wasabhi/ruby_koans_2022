...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Describe in your own words what inject does.
		# Inject (or reduce) iterates over an enum, with an initial value in
		# conjunction with each element of the enum.
  end
  ...
  #   # code to read 'file'
	# 
	# Answer: because using a block ensures that the filehandle is closed?
  #
